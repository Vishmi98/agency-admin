...
import { updateInvoiceStatusToCommissionAvailable } from '../services/invoice.services';


const UpdateInvoiceStatusTable: React.FC<InvoiceTableProps> = ({
    totalRows,
    invoices,
    isLoading,
    page,
    ...
    const handleUpdateStatus = async (invoiceId: number) => {
        ...
        try {
            const response = await updateInvoiceStatusToCommissionAvailable(invoiceId, 4);
    ...
    const columns = [
        ...
        { label: "Date", key: "invoiceDate", width: "10%", align: "left" as const },
        { label: "Staff", key: "staff", width: "20%", align: "left" as const },
        ...
        return invoices.map((invoice, index) => (
            ...
            >
                ...
                <TableCell align="center">
                    ...
                    >
                        {loadingInvoiceId === invoice.id ? "Updating..." : "Commission available"}
                    </Button>
                </TableCell>
            </TableRow>
        ));
    ...
    return (
        <Box>
            ...
            >
                ...
                <DialogContent>
                    <Typography>
                        Are you sure you want to mark this invoice as Commission available?
                    </Typography>
                </DialogContent>
                <DialogActions
                    sx={{
                ...
                >
                    ...
                    <Button
                        onClick={() => selectedInvoiceId && handleUpdateStatus(selectedInvoiceId)}
                        color="primary"
                        autoFocus
                        type="submit"
                        variant="contained"
...
export default UpdateInvoiceStatusTable;