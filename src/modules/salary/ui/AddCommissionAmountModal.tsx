...
import { addCommissionAmount } from "../services/salary.service";

import { StaffType } from "@/modules/staff/staff.types";
import TextBox from "@/components/TextBox";


const AddCommissionAmountModal: React.FC<ModalProps> = ({
    open,
    onClose,
    reloadData,
    initialValues,
    ...
    const handleSubmit = async (
        ...
        try {
            const response = await addCommissionAmount(values.id, values.commissionAmount);
                        ...
                        <Form>
                            <DialogContent>
                                <Grid container spacing={1}>
                                    <Grid item xs={12}>
                                        <Typography fontSize="12px">Commission Amount</Typography>
                                        <TextBox
                                            ...
                                            helperText={touched.commissionAmount && errors.commissionAmount}
                                        />
                                    </Grid>
                                </Grid>
                            </DialogContent>
...
export default AddCommissionAmountModal;
