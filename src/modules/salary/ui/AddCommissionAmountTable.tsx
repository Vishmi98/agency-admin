...
import AddCommissionAmountModal from './AddCommissionAmountModal';
...
const columns: TableColumnType[] = [
  ...
  { label: "Commission Amount", width: "20%", align: "right" as const },
  { label: "Action", width: "15%", align: "center" as const },
];

const AddCommissionAmountTable: React.FC<TableProps> = ({
  totalRows,
  staffs,
  isLoading,
  page,
  ...
  const renderRows = () => {
    ...
    return staffs.map((member, index) => (
      ...
      >
        ...
        <TableCell align="right">{member.commissionAmount}</TableCell>
...
export default AddCommissionAmountTable;