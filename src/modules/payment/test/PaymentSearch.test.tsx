...
import PaymentSearch from '../ui/PaymentSearch';


describe('PaymentSearch Component', () => {
    ...
    it('renders PaymentSearch component', () => {
        render(
            <PaymentSearch
        ...
        expect(screen.getByLabelText('Search Payment')).toBeInTheDocument();
    ...
    it('updates input value on change', () => {
        ...
        const input = screen.getByLabelText('Search Payment') as HTMLInputElement;
