...
describe('StudentSearch Component', () => {
    ...
    it('renders StudentSearch component', () => {
        render(
            <StudentSearch
        ...
        expect(screen.getByLabelText('Search Student')).toBeInTheDocument();
    ...
    it('updates input value on change', () => {
        ...
        const input = screen.getByLabelText('Search Student') as HTMLInputElement;
